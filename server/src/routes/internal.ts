...
import {
  ...
  type CronRunMetadata,
} from '../jobs/cronRunLog.js';
...
function headerString(req: { headers: Record<string, string | string[] | undefined> }, name: string): string | undefined {
...
function triggeredByLabel(metadata: CronRunMetadata): string {
